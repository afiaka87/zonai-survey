...
namespace {
    ...
    void chargePosCb(lotuskit::TextWriterExt*  , sead::Vector2f* pos) {
    ...
    void bannerPosCb(lotuskit::TextWriterExt*  , sead::Vector2f* pos) {
        pos->x = g_bannerX;
        pos->y = g_bannerY;
    }
    ...
    template <size_t I>
    void hudLineCb(lotuskit::TextWriterExt*  , sead::Vector2f* pos) {
        pos->x = g_pres.hud.x;
        pos->y = g_hudLineY[I];
    }
    template <size_t... Is>
